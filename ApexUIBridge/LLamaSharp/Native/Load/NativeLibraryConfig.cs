...
namespace LLama.Native
{
    ...
    public sealed partial class NativeLibraryConfig
    {
        ...
        private AvxLevel _avxLevel = AvxLevel.Avx2;
        ...
        /// <returns></returns>
        /// <exception cref="InvalidOperationException">Thrown if `LibraryHasLoaded` is true.</exception>
        public NativeLibraryConfig WithCuda(bool enable = false)
        {
            ThrowIfLoaded();
        ...
        /// <returns></returns>
        /// <exception cref="InvalidOperationException">Thrown if `LibraryHasLoaded` is true.</exception>
        public NativeLibraryConfig WithVulkan(bool enable = false)
        {
            ThrowIfLoaded();
        ...
        /// <returns></returns>
        /// <exception cref="InvalidOperationException">Thrown if `LibraryHasLoaded` is true.</exception>
        public NativeLibraryConfig WithAvx(AvxLevel level = AvxLevel.Avx2)
        {
            ThrowIfLoaded();
    ...
    public sealed class NativeLibraryConfigContainer
    {
        ...
        /// <returns></returns>
        /// <exception cref="InvalidOperationException">Thrown if `LibraryHasLoaded` is true.</exception>
        public NativeLibraryConfigContainer WithCuda(bool enable = false)
        {
            foreach(var config in _configs)
            {
        ...
        /// <returns></returns>
        /// <exception cref="InvalidOperationException">Thrown if `LibraryHasLoaded` is true.</exception>
        public NativeLibraryConfigContainer WithVulkan(bool enable = false)
        {
            foreach(var config in _configs)
            {
